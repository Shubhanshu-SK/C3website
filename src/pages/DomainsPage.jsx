    ...
    <section className="section-pad sec-b min-h-screen pt-28">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <span className="eyebrow">Domains Directory</span>
          <h2 className="section-heading mb-4">
            Find your <span style={{ color: 'var(--c-crimson)' }}>niche.</span>
          </h2>
          <p className="font-grotesk text-base md:text-lg body-text-width text-[var(--c-fg-soft)]">
            Seven specialisations under one roof. Pick your lane, contribute to projects, attend events, and grow with the community.
          </p>
        </motion.div>
